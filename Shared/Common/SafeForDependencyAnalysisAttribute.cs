...
{
    [Serializable]
    public sealed class SafeForDependencyAnalysisAttribute : LocationInterceptionAspect
    {
        ...
        //    if (false)
        //    {
        //        Message.Write(location, SeverityType.Error, "MY001", "Cannot apply SafeForDependencyAnalysisAttribute to '{0}'.", location);
        //        return false;
        //    }
